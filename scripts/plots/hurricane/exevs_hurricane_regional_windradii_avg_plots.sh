...
export windradii_avg_model_type="regional"
...
if [ $nimgs -ne 0 ]; then
  ...
  if [ "$SENDCOM" = 'YES' ]; then
    cp -r ${STORMroot}/plot/${tc_name}/images/ABSAAL_WIND_34-BAL_WIND_34_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD34_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp -r ${STORMroot}/plot/${tc_name}/images/ABSAAL_WIND_50-BAL_WIND_50_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD50_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp -r ${STORMroot}/plot/${tc_name}/images/ABSAAL_WIND_64-BAL_WIND_64_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD64_err.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp -r ${STORMroot}/plot/${tc_name}/images/AAL_WIND_34-BAL_WIND_34_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD34_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp -r ${STORMroot}/plot/${tc_name}/images/AAL_WIND_50-BAL_WIND_50_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD50_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
    cp -r ${STORMroot}/plot/${tc_name}/images/AAL_WIND_64-BAL_WIND_64_fhrmean_${tc_name}_regional.gif ${comoutroot}/evs.hurricane_regional.windradii_QD64_bias.${stormBasin}.${stormYear}.${stormName}${stormNumber}.png
  fi
fi
...
if [ $bimgs -ne 0 ]; then
  ...
  rm -f *.png
  if [ "$SENDCOM" = 'YES' ]; then
    cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAAL_WIND_34-BAL_WIND_34_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD34_err.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAAL_WIND_50-BAL_WIND_50_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD50_err.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/ABSAAL_WIND_64-BAL_WIND_64_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD64_err.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/AAL_WIND_34-BAL_WIND_34_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD34_bias.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/AAL_WIND_50-BAL_WIND_50_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD50_bias.${stormBasin}.${stormYear}.season.png
    cp -r ${metTCcomout}/plot/${tc_name}/images/AAL_WIND_64-BAL_WIND_64_fhrmean_${tc_name}_regional.gif ${comoutbas}/evs.hurricane_regional.windradii_QD64_bias.${stormBasin}.${stormYear}.season.png
  fi
fi
### bas do loop end
done
