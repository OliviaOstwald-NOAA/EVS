...
export PS4=' + exevs_hurricane_regional_windradii_plots.sh line $LINENO: '
...
#export COMINstats=/lfs/h2/emc/ptmp/$USER/com/evs/1.0/hurricane_regional/windradii/stats
...
python ${USHevs}/${COMPONENT}/${STEP}/plot_windradii_lead_average.py
