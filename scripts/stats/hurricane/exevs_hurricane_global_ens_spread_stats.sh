...
#---get the model forecast tracks "GEFS/EENS/CENS/UENS members" from archive file "tracks.atcfunix.${YY25}"
grep -a "${stbasin}, ${stormNumber}" ${COMINtrack} > tracks.atcfunix.${YY25}_${stormBasin}${stormNumber}
grep "03, AP" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} > a${stormBasin}${stormNumber}${stormYear}.dat
grep "03, EN" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep "03, EP" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep "03, CP" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep -a "03, UE" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
