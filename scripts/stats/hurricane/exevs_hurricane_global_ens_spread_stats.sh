...
grep -a "${stbasin}, ${stormNumber}" ${COMINtrack} > tracks.atcfunix.${YY18}_${stormBasin}${stormNumber}
grep "03, AP" tracks.atcfunix.${YY18}_${stormBasin}${stormNumber} > a${stormBasin}${stormNumber}${stormYear}.dat
