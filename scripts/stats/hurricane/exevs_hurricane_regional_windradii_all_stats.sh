#!/bin/bash
set -x
export PS4=' + exevs_hurricane_regional_windradii_all_stats.sh line $LINENO: '
...
#--- run for TC_pairs
cp ${PARMevs}/metplus_config/${STEP}/${COMPONENT}/TCPairs_${VERIF_CASE}_template.conf .
...
sed -i "s|$SEARCH0|$MetOnMachine|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH1|$STORMdata|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH2|$STORMroot|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH3|$startdate|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH4|$enddate|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH5|$stormNumber|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH6|$stbasin|g" TCPairs_${VERIF_CASE}_template.conf
sed -i "s|$SEARCHx|$Model_List|g" TCPairs_${VERIF_CASE}_template.conf

run_metplus.py -c $STORMdata/TCPairs_${VERIF_CASE}_template.conf

#--- run for TC_stat 
cd $STORMdata

cp ${PARMevs}/metplus_config/${STEP}/${COMPONENT}/TCStat_${VERIF_CASE}_template.conf .

export SEARCHy="LEAD_template"
sed -i "s|$SEARCH0|$MetOnMachine|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH1|$STORMdata|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH2|$STORMroot|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH3|$startdate|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH4|$startdate|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCHx|$Model_List|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCHy|$LEAD_List|g" TCStat_${VERIF_CASE}_template.conf
...
sed -i "s|$SEARCH7|$symdh|g" TCStat_${VERIF_CASE}_template.conf
sed -i "s|$SEARCH8|$eymdh|g" TCStat_${VERIF_CASE}_template.conf

run_metplus.py -c $STORMdata/TCStat_${VERIF_CASE}_template.conf
...
cp ${PARMevs}/metplus_config/${STEP}/${COMPONENT}/TCStat_${VERIF_CASE}_template_basin.conf .

#export SEARCHy="LEAD_template"
sed -i "s|$SEARCH0|$MetOnMachine|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCH1|$metTCcomin|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCH2|$metTCcomout|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCH3|$startdateB|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCH4|$startdateB|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCHx|$Model_List|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCHy|$LEAD_List|g" TCStat_${VERIF_CASE}_template_basin.conf
...
sed -i "s|$SEARCH7|$symdhB|g" TCStat_${VERIF_CASE}_template_basin.conf
sed -i "s|$SEARCH8|$eymdhB|g" TCStat_${VERIF_CASE}_template_basin.conf

run_metplus.py -c ${metTCcomout}/TCStat_${VERIF_CASE}_template_basin.conf
if [ "$SENDCOM" = 'YES' ]; then
