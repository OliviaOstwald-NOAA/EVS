#!/bin/bash
set -x
export PS4=' + exevs_hurricane_global_det_tropcyc_stats_2022.sh line $LINENO: '
...
#---get the model forecast tracks "AVNO/EMX/CMC/UKM" from archive file "tracks.atcfunix.${YY22}"
...
grep "03, XXXX" tracks.atcfunix.${YY22}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
###-------^^^^------###
