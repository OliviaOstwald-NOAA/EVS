...
grep "${stbasin}, ${stormNumber}" ${COMINtrack} > tracks.atcfunix.${YY05}_${stormBasin}${stormNumber}
grep "03, AVNO" tracks.atcfunix.${YY05}_${stormBasin}${stormNumber} > a${stormBasin}${stormNumber}${stormYear}.dat
grep "03,  EMX" tracks.atcfunix.${YY05}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep "03,  CMC" tracks.atcfunix.${YY05}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep "03,  UKM" tracks.atcfunix.${YY05}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
