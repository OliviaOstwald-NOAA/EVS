...
#---get the model forecast tracks "AEMN/EEMN/CEMN/UKMN" from archive file "tracks.atcfunix.${YY25}"
grep "${stbasin}, ${stormNumber}" ${COMINtrack} > tracks.atcfunix.${YY25}_${stormBasin}${stormNumber}
grep "03, AEMN" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} > a${stormBasin}${stormNumber}${stormYear}.dat
grep "03, EEMN" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
grep "03, CEMN" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
#grep "03, UKMN" tracks.atcfunix.${YY25}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
...
if [ "$SENDCOM" = 'YES' ]; then
  ...
  if [ ${stormBasin} = "al" ]; then
    ...
    cp ${comoutroot}/tc_stat/tc_stat_summary.tcst ${comoutcpa}/${stormBasin}${stormNumber}${stormYear}_stat_summary.tcst
  elif [ ${stormBasin} = "ep" ]; then
