#!/bin/bash
set -x
export PS4=' + exevs_hurricane_global_det_tropcyc_stats_2023.sh line $LINENO: '
...
grep "03, GFSO" tracks.atcfunix.${YY22}_${stormBasin}${stormNumber} >> a${stormBasin}${stormNumber}${stormYear}.dat
