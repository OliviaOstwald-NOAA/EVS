...
# Author: Dan Halperin. Edited by Olivia Ostwald (08/2025)    #
# for RI/RW plots.                                            #
###############################################################
...
def performance_diag():
  ...
  # --- Code added to calculate CSI for color gradient --- (lines 185-193 from Gemini) #
  ...
  # --- Code added to create a filled contour gradient --- (lines 222-258 from Gemini) #
